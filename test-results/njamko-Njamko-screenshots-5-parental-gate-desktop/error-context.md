...
- Name: njamko.spec.js >> Njamko screenshots >> 5. parental gate
- Location: e2e\njamko.spec.js:871:3

# Error details

```
Error: A snapshot doesn't exist at C:\Nepar\e2e\njamko.spec.js-snapshots\05-parental-gate-desktop-win32.png, writing actual.
```
