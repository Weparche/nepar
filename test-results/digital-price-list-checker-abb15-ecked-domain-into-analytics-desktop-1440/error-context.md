...
- Name: digital-price-list.spec.js >> checker renders a green CSV result without leaking the checked domain into analytics
- Location: e2e\digital-price-list.spec.js:62:1
