...
- Name: mozgalica.spec.js >> Dnevne Asocijacije /mozgalica >> start-game scrolls to puzzle picker
- Location: e2e\mozgalica.spec.js:195:3
...
Call log:
  - waiting for getByTestId('start-game')
