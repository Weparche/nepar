...
- Name: mozgalica.spec.js >> Dnevne Asocijacije screenshots >> game mobile screenshot
- Location: e2e\mozgalica.spec.js:261:3
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  39582 pixels (ratio 0.14 of all image pixels) are different.

  Snapshot: game-mobile.png

Call log:
  - Expect "toHaveScreenshot(game-mobile.png)" with timeout 5000ms
