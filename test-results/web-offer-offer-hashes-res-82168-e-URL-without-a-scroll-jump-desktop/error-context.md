...
- Name: web-offer.spec.js >> offer hashes resolve correctly and selector updates the URL without a scroll jump
- Location: e2e\web-offer.spec.js:654:1

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://127.0.0.1:4173/usluge/izrada-web-stranica#redizajn
Call log:
  - navigating to "http://127.0.0.1:4173/usluge/izrada-web-stranica#redizajn", waiting until "load"
