...
- Name: njamko.spec.js >> Njamko screenshots >> 4. locked level screen (level select with Plus)
- Location: e2e\njamko.spec.js:864:3

# Error details

```
Error: A snapshot doesn't exist at C:\Nepar\e2e\njamko.spec.js-snapshots\04-locked-level-select-mobile-win32.png, writing actual.
```
