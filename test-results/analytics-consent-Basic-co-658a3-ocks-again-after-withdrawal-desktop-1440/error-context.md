...
- Name: analytics-consent.spec.js >> Basic consent blocks requests, enables one manual page view, and blocks again after withdrawal
- Location: e2e\analytics-consent.spec.js:47:1

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://127.0.0.1:4173/usluge/izrada-web-stranica?private=value#paketi
Call log:
  - navigating to "http://127.0.0.1:4173/usluge/izrada-web-stranica?private=value#paketi", waiting until "load"
