...
- Name: mozgalica.spec.js >> Dnevne Asocijacije /mozgalica >> result link shows comparison for challenger without playing
- Location: e2e\mozgalica.spec.js:171:3
...
Locator: getByTestId('challenge-result')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByTestId('challenge-result')
