...
- Name: njamko.spec.js >> Njamko screenshots >> 7. game screen
- Location: e2e\njamko.spec.js:889:3

# Error details

```
Error: A snapshot doesn't exist at C:\Nepar\e2e\njamko.spec.js-snapshots\07-game-screen-mobile-win32.png, writing actual.
```
    ...
    - generic [ref=e5]:
      ...
      - generic [ref=e15]:
        ...
        - generic [ref=e20]:
          ...
          - button "Odaberi Banana" [ref=e24] [cursor=pointer]:
            - generic [ref=e26]: Banana
