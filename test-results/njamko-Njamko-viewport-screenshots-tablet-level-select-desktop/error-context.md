...
- Name: njamko.spec.js >> Njamko viewport screenshots >> tablet level select
- Location: e2e\njamko.spec.js:915:5
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  37658 pixels (ratio 0.05 of all image pixels) are different.

  Snapshot: level-select-tablet.png

Call log:
  - Expect "toHaveScreenshot(level-select-tablet.png)" with timeout 5000ms
