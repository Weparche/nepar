...
- Location: e2e\mozgalica.spec.js:241:3
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 1280px by 3374px, received 1280px by 5089px. 524004 pixels (ratio 0.09 of all image pixels) are different.
