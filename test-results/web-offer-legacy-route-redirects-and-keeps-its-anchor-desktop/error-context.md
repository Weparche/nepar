...
- Name: web-offer.spec.js >> legacy route redirects and keeps its anchor
- Location: e2e\web-offer.spec.js:778:1

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://127.0.0.1:4173/usluge/web-stranica-bez-pocetnog-troska#paketi
Call log:
  - navigating to "http://127.0.0.1:4173/usluge/web-stranica-bez-pocetnog-troska#paketi", waiting until "load"
