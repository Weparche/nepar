...
- Name: njamko.spec.js >> Njamko viewport screenshots >> mobile level select
- Location: e2e\njamko.spec.js:915:5
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  13124 pixels (ratio 0.04 of all image pixels) are different.

  Snapshot: level-select-mobile.png

Call log:
  - Expect "toHaveScreenshot(level-select-mobile.png)" with timeout 5000ms
