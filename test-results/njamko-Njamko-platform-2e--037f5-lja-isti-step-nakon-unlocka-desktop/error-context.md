...
- Name: njamko.spec.js >> Njamko platform >> 2e. kampanja trazi Plus na food level 2 i nastavlja isti step nakon unlocka
- Location: e2e\njamko.spec.js:288:3
...
Call log:
  ...
  - attempting click action
    ...
    - retrying click action
      - waiting 100ms
    431 × waiting for element to be visible, enabled and stable
