...
export const nepaUsluge = [
  ...
  { id: "cjenik-plugin", naziv: "Digitalni cjenik – plugin (samostalna implementacija)", kategorija: "Usluge digitalnog cjenika", cijena: 49.9, cijenaOd: true, naplata: "jednokratno", posebnaProdaja: false, posebnaProdajaNaziv: null, sidrenaCijena: null, napomena: "Nova usluga uvedena nakon 10.09.2026.; sidrena cijena nije primjenjiva. Samostalna implementacija putem digitalnicjenik.nepar.hr." },
  { id: "cjenik-implementacija", naziv: "Digitalni cjenik – implementacija na postojeći web", kategorija: "Usluge digitalnog cjenika", cijena: 49.9, cijenaOd: true, naplata: "jednokratno", posebnaProdaja: false, posebnaProdajaNaziv: null, sidrenaCijena: null, napomena: "Nova usluga uvedena nakon 10.09.2026.; sidrena cijena nije primjenjiva." },
  { id: "cjenik-plugin-implementacija", naziv: "Digitalni cjenik – plugin i implementacija (paket)", kategorija: "Usluge digitalnog cjenika", cijena: 89.9, cijenaOd: true, naplata: "jednokratno", posebnaProdaja: false, posebnaProdajaNaziv: null, sidrenaCijena: null, napomena: "Nova usluga uvedena nakon 10.09.2026.; sidrena cijena nije primjenjiva. Plugin (49,90 €) i implementacija (49,90 €) zajedno." },
  { id: "cjenik-integracija-platforme", naziv: "Wix / React / Next / Vite / custom integracija", kategorija: "Usluge digitalnog cjenika", cijena: 149, cijenaOd: true, naplata: "jednokratno", posebnaProdaja: false, posebnaProdajaNaziv: null, sidrenaCijena: null, napomena: "Nova usluga uvedena nakon 10.09.2026.; sidrena cijena nije primjenjiva." },
  { id: "cjenik-odrzavanje", naziv: "Tehničko održavanje digitalnog cjenika", kategorija: "Usluge digitalnog cjenika", cijena: 19.9, cijenaOd: false, naplata: "godišnje", posebnaProdaja: false, posebnaProdajaNaziv: null, sidrenaCijena: null, napomena: "Nova usluga uvedena nakon 10.09.2026.; sidrena cijena nije primjenjiva. Prva godina uključena u implementaciju." },
];
