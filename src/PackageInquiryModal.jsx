...
const copy = {
  hr: {
    ...
    price: "Cijena",
    kinds: { website: "Nova web-stranica", redesign: "Redizajn i migracija", maintenance: "Godišnje održavanje", social: "Vođenje Facebooka i Instagrama", additional: "Dodatna usluga" },
    name: "Ime i prezime",
  ...
  en: {
    ...
    price: "Price",
    kinds: { website: "New website", redesign: "Redesign and migration", maintenance: "Annual maintenance", social: "Facebook and Instagram management", additional: "Additional service" },
    name: "Full name",
