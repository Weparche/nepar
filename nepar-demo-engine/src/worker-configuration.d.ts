/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example src/worker-configuration.d.ts` (hash: 6d295065b62f6a4a8dc181239a8c2b9b)
// Runtime types generated with workerd@1.20260820.1 2026-08-22 nodejs_compat
interface __BaseEnv_Env {
	ASSETS: R2Bucket;
	DB: D1Database;
	ROOT_DOMAIN: "nepar.hr";
	ZONE_NAME: "nepar.hr";
	WORKER_SERVICE: "nepar-demo-engine";
	ACTIVE_DOMAIN_LIMIT: "80";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ROOT_DOMAIN" | "ZONE_NAME" | "WORKER_SERVICE" | "ACTIVE_DOMAIN_LIMIT" | "DEFAULT_EXPIRY_DAYS" | "ADMIN_RATE_LIMIT_PER_MINUTE" | "ADMIN_TOKEN" | "WORKERS_DOMAINS_API_TOKEN" | "CF_ACCOUNT_ID" | "CF_ZONE_ID">> {}
}
